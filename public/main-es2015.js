...
let ContactComponent = class ContactComponent {
    ...
    onSubmit() {
        ...
        }, errmess => { this.feedback = null; this.feedbackCopy = null; this.errMessFeed = errmess; }, () => { console.log("Observable finished"); this.showSpinner = false; });
        setTimeout(() => {
...
let DishdetailComponent = class DishdetailComponent {
    constructor(dishService, route, location, fb, baseURL) {
...
DishdetailComponent.ctorParameters = () => [
...
const baseURL = 'https://course-json-server.herokuapp.com/';
...
const ContactType = ['None', 'Email', 'Tel'];
...
let DishService = class DishService {
    ...
    getFeaturedDish() {
        return this.http.get(_menu_shared_baseurl__WEBPACK_IMPORTED_MODULE_4__["baseURL"] + 'dishes?featured=true').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(dishes => dishes[0]))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    }
    getDishIds() {
        return this.getDishes().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(dishes => dishes.map(dish => dish.id)))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(error => error));
    }
    putDish(dish) {
        const httpOptions = {
...
let LeaderService = class LeaderService {
    ...
    getFeaturedLeader() {
        return this.http.get(_menu_shared_baseurl__WEBPACK_IMPORTED_MODULE_3__["baseURL"] + 'leadership?featured=true').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(leaders => leaders[0]))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    }
};
LeaderService.ctorParameters = () => [
...
let PromotionService = class PromotionService {
    ...
    getFeaturedPromotion() {
        return this.http.get(_menu_shared_baseurl__WEBPACK_IMPORTED_MODULE_5__["baseURL"] + 'promotions?featured=true').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(promotions => promotions[0]))
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(this.processHTTPMsgService.handleError));
    }
};
